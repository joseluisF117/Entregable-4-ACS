...
public class Empleado {
    ...
    public Empleado(int idUsuario, String nombre, String apellidoPaterno, String appelidoMaterno, String rfc, Date fechaIngreso, int estatus, int puesto, Date fechaIngresoPuesto) {
    ...
    public String toString() {
        return "Empleado{" + "idUsuario=" + idUsuario + ", nombre=" + nombre + ", apellidoPaterno=" + apellidoPaterno + ", appelidoMaterno=" + appelidoMaterno + ", rfc=" + rfc + ", fechaIngreso=" + fechaIngreso + ", estatus=" + estatus + ", puesto=" + puesto + ", fechaIngresoPuesto=" + fechaIngresoPuesto + '}';
    }
}
